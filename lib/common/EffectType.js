...
const ALL_TRIGGERS = Object.keys(Trigger).map(k => Trigger[k]);
...
const effectDefinitions = [
    {
        id: "API_BUTTON",
        name: "API Button",
        triggers: [Trigger.INTERACTIVE, Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.COMMAND, Trigger.EVENT, Trigger.MANUAL],
    ...
    },
    {
        id: "CHANGE_GROUP",
        name: "Change Group",
        triggers: [Trigger.INTERACTIVE, Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.EVENT],
    ...
    },
    {
        id: "COOLDOWN",
        name: "Cooldown",
        triggers: [Trigger.INTERACTIVE, Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.COMMAND, Trigger.EVENT],
        dependencies: [Dependency.INTERACTIVE],
    ...
    },
    {
        id: "RUN_COMMAND",
        name: "Run Command",
        triggers: [Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.EVENT, Trigger.MANUAL],
        dependencies: [],
    ...
    },
    {
        ...
        triggers: [Trigger.COMMAND, Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.MANUAL],
        dependencies: [Dependency.INTERACTIVE, Dependency.CHAT],
    ...
    },
    {
        id: "UPDATE_BUTTON",
        name: "Update Button",
        triggers: [Trigger.INTERACTIVE, Trigger.COMMAND, Trigger.CUSTOM_SCRIPT, Trigger.API, Trigger.EVENT, Trigger.MANUAL],
        dependencies: [Dependency.INTERACTIVE],
    ...
    },
    {
        ...
        description: "Runs a list of effects if a condition is met",

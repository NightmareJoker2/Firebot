...
function requestAsStreamer(method, route, body) {
    return new Promise(resolve => {
        ...
        let options = {
            ...
            method: method,
            headers: {
                'User-Agent': 'Firebot/4.13.2 (JavaScript; Node.js v10.7.0; Electron 2.0.5)', // this was lying before, bad! Of course, if you want to lie about it, be better at it and use the useragent of the latest stable version of the most popular web browser, and make sure to also transmit any other headers that browser would set in a common configuration and handle the cookies so you don't get caught red handed!
...
function createClip(title, duration) {
    return new Promise(async resolve => {
        ...
        if (!streamerData.partnered) {
            logger.warn("A non partner attempted to create a clip!");
            clipResult.reason = "Not a partner";
            ...
            let userId = response.userId,
                options = {
                    ...
                    headers: {
                        ...
                        'User-Agent': 'Firebot/4.13.2 (JavaScript; Node.js v10.7.0; Electron 2.0.5)'
                    },
                    json: true,
                    body: {}
                };
